...
type AddRelationshipsEntry<TEntry, TRelationships extends readonly Relationship[] = []> =
  TEntry extends { Relationships: infer _Existing extends readonly Relationship[] }
    ? TEntry
    : TEntry & { Relationships: TRelationships }

type AddRelationships<T extends GeneratedDatabase> = {
  public: {
    Tables: {
      [Name in keyof T['public']['Tables']]: AddRelationshipsEntry<
        T['public']['Tables'][Name],
        Name extends keyof RelationshipOverrides ? RelationshipOverrides[Name] : []
      >
    }
    Views: {
      [Name in keyof T['public']['Views']]: AddRelationshipsEntry<T['public']['Views'][Name]>
    }
