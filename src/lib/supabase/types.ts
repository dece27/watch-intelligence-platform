...
type AddRelationships<T extends GeneratedDatabase> = {
  public: {
    Tables: {
      [Name in keyof T['public']['Tables']]: T['public']['Tables'][Name] & {
        Relationships: Name extends keyof RelationshipOverrides
          ? RelationshipOverrides[Name]
          : T['public']['Tables'][Name] extends { Relationships: infer Existing extends readonly Relationship[] }
            ? Existing
            : []
      }
    }
